...
#: 스탠드 스냅샷 v3 (stand_snapshot_v3_20260727 — 에어스탠딩 육안 확인 후 승윤님이
#: 매달림 정렬을 재교정하고 정지 캡처. 공식 스탠드 영점 앵커 = 이 값.
#: v2 대비 전 모터 ≤1.9° 이동. v1('들고 정렬' 추정 구간)은 골반 기운 자세로 폐기)
STAND_DEG = {1: 32.69, 2: 2.22, 3: 7.11, 4: 14.22, 5: 34.28, 6: 4.95,

...
#: 스탠드 스냅샷 (모터 프레임 deg, stand_snapshot_20260727 '들고 정렬' 구간 중앙값)
STAND_DEG = {1: 4.10, 2: 5.50, 3: 8.70, 4: 32.40, 5: 37.00, 6: 3.90,
             7: 76.40, 8: 10.80, 9: -0.40, 10: 16.80, 11: 12.90, 12: 2.90}
